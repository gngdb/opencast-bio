...
%iterations of results - \ac{DIP}, \ac{HI\ac{PPI}E}, Bayesian updating and reasoning behind it
...
The first of these was the change from a \ac{DIP}-based training set to \ac{HI\ac{PPI}E}-based training set.
...
\section{Classification in weighted \ac{PPI} networks}
