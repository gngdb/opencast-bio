...
\begin{table}
    ...
    \begin{tabular}{p{0.2\textwidth} c c c c c}
        ...
        \multirow{3}{*}{\parbox{0.2\textwidth}{Support Vector Machine}}     & kernel: RBF               & \multirow{3}{*}{$0.9985$} & \multirow{3}{*}{N/A}          & \multirow{3}{*}{$0.99933$}    & \multirow{3}{*}{$\pm 1.2\e{-4}$} \\
                                                    & Gamma: $10.0$             &                           &                               &                               &       \\
                                                    & C: $10.0$                 &                           &                               &                               &       \\
        \multirow{2}{*}{\parbox{0.2\textwidth}{Random Forest}}              & N estimators: $44$        & \multirow{2}{*}{$0.99837$} & \multirow{2}{*}{$\pm 3\e{-5}$} & \multirow{2}{*}{$0.99921$}   & \multirow{2}{*}{$\pm 3\e{-5}$} \\
                                                    & Max features: $25$        &                           &                               &                               &       \\
        \multirow{2}{*}{\parbox{0.2\textwidth}{Extremely Randomized Trees}} & N estimators: $94$        & \multirow{2}{*}{$0.99837$} & \multirow{2}{*}{$\pm 3\e{-5}$} & \multirow{2}{*}{$0.99921$}   & \multirow{2}{*}{$\pm 3\e{-5}$} \\
                                                    & Max features: $25$        &                           &                               &                               &       \\
    \end{tabular}
