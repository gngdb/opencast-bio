...
%intro to background
This project involved the use of protein interaction prediction to build weighted \ac{PPI} networks improve the performance of a Community Detection algorithm on a \ac{PPI} network.
...
Typical contemporary protein interaction networks rely on databases of confirmed interactions from a variety of experiments, for example in \textcite{kenley_detecting_2011} several well-known interaction databases were used. %FIN:give an example of one or two e.g. \ac{DIP} and BioGRID 
...
Therefore, by weighting the interactions in a \ac{PPI} network according to our confidence we can also make the \ac{PPI} network reflect more closely the true situation. %FIN: i.e. proteins predicted to interact actually interacting in vivo 
...
\begin{table}
    ...
    \begin{tabular}{p{0.2\textwidth} p{0.5\textwidth}}
        ...
        \multirow{3}{*}{\parbox{0.2\textwidth}{Primary interaction databases}}  & \ac{DIP}\autocite{xenarios_dip_2002} \\
                                                        & \ac{HI\ac{PPI}E}\autocite{schaefer_hippie:_2012} \\ 
